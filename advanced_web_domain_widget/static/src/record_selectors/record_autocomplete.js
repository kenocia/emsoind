...
import { AutoCompleteBits } from "../autocomplete/autocomplete";
...
export class RecordAutocompleteBits extends Component {
    static props = {
        resModel: String,
        update: Function,
        multiSelect: Boolean,
    ...
    static components = { AutoCompleteBits };
    static template = "awdw.RecordAutocompleteBits";
