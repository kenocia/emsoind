...
import { DomainSelectorDialogBits } from "../domain_selector_dialog/domain_selector_dialog";
...
import { treeFromDomain } from "../tree_editor/condition_tree";
import { useRecordObserver } from "@web/model/relational_model/utils";

export class DomainFieldBits extends Component {
    static template = "awdw.DomainFieldBits";
    static components = {
        DomainSelectorBits,
    };
    static props = {
